...
circle = word_to_vec_map["circle"]
cube = word_to_vec_map["cube"]
square = word_to_vec_map["square"]
...
triads_to_try = [('man', 'doctor', 'woman'), ('india', 'delhi', 'japan'), ('man', 'woman', 'boy'), ('small', 'smaller', 'big')]
...
# girls and boys name
name_list = ['john', 'marie', 'sophie', 'ronaldo', 'priya', 'yuval', 'female', 'danielle', 'reza', 'katy', 'yasmin']
